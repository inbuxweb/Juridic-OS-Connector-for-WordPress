...
class Class_Settings
{
    ...
    {
        add_menu_page(
            esc_html__('Juridic-OS Settings', 'juridic-os-connector'),
            esc_html__('Juridic-OS', 'juridic-os-connector'),
            'manage_options',
            'juridicos-settings',
    ...
    public function register_settings()
    {
        ...
        add_settings_section(
            ...
            esc_html__('API Configuration', 'juridic-os-connector'),
        ...
        add_settings_field(
            'api_key',
            esc_html__('API Key', 'juridic-os-connector'),
        ...
        add_settings_field(
            'api_url',
            esc_html__('API URL', 'juridic-os-connector'),
        ...
        add_settings_field(
            'status_default',
            esc_html__('Initial status', 'juridic-os-connector'),
...
?>
        <input type="password"
            ...
            class="regular-text">
        <p class="description">
            <?php esc_html_e('Enter your Juridic-OS API Key', 'juridic-os-connector'); ?>
        </p>
    <?php
    }
    ...
    ?>
        <input type="url"
            ...
            class="regular-text">
        <p class="description">
            <?php esc_html_e('Enter your Juridic-OS API URL', 'juridic-os-connector'); ?>
        </p>
    <?php
    }
    ...
    public function render_status_default_field()
    {
        ...
        $status_options = array(
            'converted'  => esc_html__('Converted', 'juridic-os-connector'),
            'lost'       => esc_html__('Lost', 'juridic-os-connector'),
            'qualified'  => esc_html__('Qualified', 'juridic-os-connector'),
            'contacted'  => esc_html__('Contacted', 'juridic-os-connector'),
            'uncontacted' => esc_html__('Uncontacted', 'juridic-os-connector')
        );
    ?>
        <select id="juridicos_status_default"
            name="<?php echo esc_attr($this->option_name); ?>[status_default]"
            class="regular-text">
        ...
        <p class="description">
            <?php esc_html_e('Initial status for new leads', 'juridic-os-connector'); ?>
        </p>
    <?php
    }
    ...
    ?>
        <p class="description">
            <?php esc_html_e('To connect to Juridic-OS, you need to generate an API Key from your administration panel.', 'juridic-os-connector'); ?>
        </p>
<?php
    }
}
